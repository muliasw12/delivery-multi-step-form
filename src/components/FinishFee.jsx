...
const FinishFee = () => {
  ...
  const selectedShipment = JSON.parse(params.get('selectedShipment'));
  
  // Now, you can access the individual data properties from selectedShipment
  const { selectedPayment, costData, total, selectedShipment: shipmentData } = selectedShipment || {};
            ...
            <div className={classes.first}>
                ...
                <div className={classes.thanks}>
                    ...
                    <div className={classes.order}>
                        ...
                        <p>Your order will be delivered today with {shipmentData ? shipmentData.shipment : 'N/A'}</p>
                    </div>
                ...
                <div className={classes.summary}>
                    ...
                    <div className={classes.details}>
                        ...
                        <div className={classes.fee}>
                            ...
                            <h3>{costData && costData[0].fee.toLocaleString()}</h3>
                        </div>
                        <div className={classes.shipment}>
                            <p>{shipmentData ? shipmentData.shipment : 'N/A'} Shipment</p>
                            <h3>{shipmentData ? shipmentData.price.toLocaleString() : 'N/A'}</h3>
                        </div>
