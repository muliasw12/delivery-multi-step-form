...
const costData = [{ cost: 500000, fee: 5900 }];
...
const TwoFee = () => {
  ...
  const handlePayment = () => {
    const dataToSend = {
        ...
        selectedPayment,
        costData,
        total: costData[0].cost + costData[0].fee + selectedShipment.price,
    };

    navigate(`/finishfee?selectedShipment=${encodeURIComponent(JSON.stringify(dataToSend))}`);
            ...
            <div className={classes.summary}>
              ...
              <div className={classes.details}>
                ...
                <div className={classes.fee}>
                  ...
                  <h3>{costData[0].fee.toLocaleString()}</h3>
                </div>
                ...
                <div className={classes.total}>
                  <h2>Total</h2>
                  <h2>{(costData[0].cost + costData[0].fee + selectedShipment.price).toLocaleString()}</h2>
                </div>
                <div className={classes.button}>
                    <Link to="/finishfee" onClick={handlePayment}>
